...
describe("booth config", () => {
  it("enables fake QR automatically for simulator camera runs", () => {
    delete process.env.ROLLER_RUMBLE_BOOTH_ALLOW_FAKE_QR;
    process.env.ROLLER_RUMBLE_BOOTH_CAMERA = "simulator";
    process.env.ROLLER_RUMBLE_BOOTH_SCANNER_MODE = "serial";
    process.env.ROLLER_RUMBLE_BOOTH_SCANNER_SERIAL_PORT = "/dev/serial0";
  ...
  it("enables fake QR automatically for manual scanner runs", () => {
    delete process.env.ROLLER_RUMBLE_BOOTH_ALLOW_FAKE_QR;
    process.env.ROLLER_RUMBLE_BOOTH_CAMERA = "gphoto2";
    process.env.ROLLER_RUMBLE_BOOTH_SCANNER_MODE = "manual";
  ...
  it("allows env override to disable fake QR even in simulator mode", () => {
    process.env.ROLLER_RUMBLE_BOOTH_ALLOW_FAKE_QR = "0";
    process.env.ROLLER_RUMBLE_BOOTH_CAMERA = "simulator";
  ...
  it("resolves documented simulator photo paths from the repo root", () => {
    process.env.ROLLER_RUMBLE_BOOTH_SIMULATOR_PHOTO_PATH = "tools/photo-booth-agent/package.json";
  ...
  it("resolves package-local simulator photo paths from the booth package", () => {
    process.env.ROLLER_RUMBLE_BOOTH_SIMULATOR_PHOTO_PATH = "assets/README.md";
  ...
  it("uses a configured LED look as the default booth light selection", () => {
    process.env.ROLLER_RUMBLE_WLED_DEFAULT_LOOK = "pride";
